  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_38vec_named_label_bck_direct_goto_va_gc_ ((*x).direct_goto);
    }
}
  ...
  while (x != xlimit)
    {
      ...
      gt_ggc_m_38vec_named_label_fwd_direct_goto_va_gc_ ((*x).direct_goto);
      x = ((*x).next);
    }
}

void
gt_ggc_mx_vec_named_label_fwd_direct_goto_va_gc_ (void *x_p)
{
  vec<named_label_fwd_direct_goto,va_gc> * const x = (vec<named_label_fwd_direct_goto,va_gc> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx (struct named_label_fwd_direct_goto& x_r ATTRIBUTE_UNUSED)
{
  struct named_label_fwd_direct_goto * ATTRIBUTE_UNUSED x = &x_r;
}

void
gt_ggc_mx_vec_named_label_bck_direct_goto_va_gc_ (void *x_p)
{
  vec<named_label_bck_direct_goto,va_gc> * const x = (vec<named_label_bck_direct_goto,va_gc> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx (struct named_label_bck_direct_goto& x_r ATTRIBUTE_UNUSED)
{
  struct named_label_bck_direct_goto * ATTRIBUTE_UNUSED x = &x_r;
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_17named_label_entry))
    {
      ...
      gt_pch_n_38vec_named_label_bck_direct_goto_va_gc_ ((*x).direct_goto);
    }
}
  ...
  while (x != xlimit)
    {
      ...
      gt_pch_n_38vec_named_label_fwd_direct_goto_va_gc_ ((*x).direct_goto);
      x = ((*x).next);
    }
}

void
gt_pch_nx_vec_named_label_fwd_direct_goto_va_gc_ (void *x_p)
{
  vec<named_label_fwd_direct_goto,va_gc> * const x = (vec<named_label_fwd_direct_goto,va_gc> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_38vec_named_label_fwd_direct_goto_va_gc_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct named_label_fwd_direct_goto& x_r ATTRIBUTE_UNUSED)
{
  struct named_label_fwd_direct_goto * ATTRIBUTE_UNUSED x = &x_r;
}

void
gt_pch_nx_vec_named_label_bck_direct_goto_va_gc_ (void *x_p)
{
  vec<named_label_bck_direct_goto,va_gc> * const x = (vec<named_label_bck_direct_goto,va_gc> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_38vec_named_label_bck_direct_goto_va_gc_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct named_label_bck_direct_goto& x_r ATTRIBUTE_UNUSED)
{
  struct named_label_bck_direct_goto * ATTRIBUTE_UNUSED x = &x_r;
}
...
void
gt_pch_p_38vec_named_label_fwd_direct_goto_va_gc_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct vec<named_label_fwd_direct_goto,va_gc> * x ATTRIBUTE_UNUSED = (struct vec<named_label_fwd_direct_goto,va_gc> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct named_label_fwd_direct_goto* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
}
...
void
gt_pch_p_38vec_named_label_bck_direct_goto_va_gc_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct vec<named_label_bck_direct_goto,va_gc> * x ATTRIBUTE_UNUSED = (struct vec<named_label_bck_direct_goto,va_gc> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct named_label_bck_direct_goto* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
}
