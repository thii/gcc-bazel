  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      switch ((int) (c_dialect_objc ()))
        {
        case 0:
          break;
        case 1:
          gt_ggc_m_9tree_node ((*x).info.objc_info);
          break;
        default:
          break;
        }
        ...
        case TS_CP_BINDING_VECTOR:
          {
            ...
            gt_ggc_m_46hash_map_unsigned_tree_module_tree_map_traits_ ((*x).binding_vec.internal_decls);
            {
              size_t i5;
              for (i5 = 0; i5 != l5; i5++) {
                {
...
void
gt_ggc_mx_vec_cp_omp_declare_variant_attr_va_gc_ (void *x_p)
{
  vec<cp_omp_declare_variant_attr,va_gc> * const x = (vec<cp_omp_declare_variant_attr,va_gc> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx (struct cp_omp_declare_variant_attr& x_r ATTRIBUTE_UNUSED)
{
  struct cp_omp_declare_variant_attr * ATTRIBUTE_UNUSED x = &x_r;
  gt_ggc_m_9tree_node ((*x).selector);
}
  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_9tree_node ((*x).x_current_class_ptr);
      gt_ggc_m_9tree_node ((*x).x_current_class_ref);
      gt_ggc_m_9tree_node ((*x).x_contract_class_ptr);
      ...
      gt_ggc_m_38vec_cp_omp_declare_variant_attr_va_gc_ ((*x).omp_declare_variant_attribute);
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_9lang_type))
    {
      ...
      switch ((int) (c_dialect_objc ()))
        ...
        case 0:
          break;
        case 1:
          gt_pch_n_9tree_node ((*x).info.objc_info);
          break;
        default:
          break;
        }
        ...
        case TS_CP_BINDING_VECTOR:
          {
            ...
            gt_pch_n_46hash_map_unsigned_tree_module_tree_map_traits_ ((*x).binding_vec.internal_decls);
            {
              size_t i5;
              for (i5 = 0; i5 != l5; i5++) {
                {
...
void
gt_pch_nx_vec_cp_omp_declare_variant_attr_va_gc_ (void *x_p)
{
  vec<cp_omp_declare_variant_attr,va_gc> * const x = (vec<cp_omp_declare_variant_attr,va_gc> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_38vec_cp_omp_declare_variant_attr_va_gc_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct cp_omp_declare_variant_attr& x_r ATTRIBUTE_UNUSED)
{
  struct cp_omp_declare_variant_attr * ATTRIBUTE_UNUSED x = &x_r;
  gt_pch_n_9tree_node ((*x).selector);
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_11saved_scope))
    {
      ...
      gt_pch_n_9tree_node ((*x).x_current_class_ptr);
      gt_pch_n_9tree_node ((*x).x_current_class_ref);
      gt_pch_n_9tree_node ((*x).x_contract_class_ptr);
      ...
      gt_pch_n_38vec_cp_omp_declare_variant_attr_va_gc_ ((*x).omp_declare_variant_attribute);
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  switch ((int) (c_dialect_objc ()))
    ...
    case 1:
      if ((void *)(x) == this_obj)
        op (&((*x).info.objc_info), NULL, cookie);
      break;
    default:
      break;
    }
    ...
    case TS_CP_BINDING_VECTOR:
      {
        ...
        if ((void *)(x) == this_obj)
          op (&((*x).binding_vec.internal_decls), NULL, cookie);
        {
          size_t i5;
          for (i5 = 0; i5 != l5; i5++) {
            {
...
void
gt_pch_p_38vec_cp_omp_declare_variant_attr_va_gc_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct vec<cp_omp_declare_variant_attr,va_gc> * x ATTRIBUTE_UNUSED = (struct vec<cp_omp_declare_variant_attr,va_gc> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct cp_omp_declare_variant_attr* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
    op (&((*x).selector), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).x_current_class_ref), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_contract_class_ptr), NULL, cookie);
  if ((void *)(x) == this_obj)
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).omp_declare_variant_attribute), NULL, cookie);
  if ((void *)(x) == this_obj)
