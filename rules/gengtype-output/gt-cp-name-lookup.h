...
void
gt_ggc_mx_hash_map_unsigned_tree_module_tree_map_traits_ (void *x_p)
{
  hash_map<unsigned,tree,module_tree_map_traits> * const x = (hash_map<unsigned,tree,module_tree_map_traits> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx (struct module_tree_map_traits& x_r ATTRIBUTE_UNUSED)
{
  struct module_tree_map_traits * ATTRIBUTE_UNUSED x = &x_r;
}
...
void
gt_pch_nx_hash_map_unsigned_tree_module_tree_map_traits_ (void *x_p)
{
  hash_map<unsigned,tree,module_tree_map_traits> * const x = (hash_map<unsigned,tree,module_tree_map_traits> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_46hash_map_unsigned_tree_module_tree_map_traits_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct module_tree_map_traits& x_r ATTRIBUTE_UNUSED)
{
  struct module_tree_map_traits * ATTRIBUTE_UNUSED x = &x_r;
}
...
void
gt_pch_p_46hash_map_unsigned_tree_module_tree_map_traits_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct hash_map<unsigned,tree,module_tree_map_traits> * x ATTRIBUTE_UNUSED = (struct hash_map<unsigned,tree,module_tree_map_traits> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct module_tree_map_traits* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
}
