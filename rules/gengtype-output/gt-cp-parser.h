...
gt_ggc_mx (struct cp_unparsed_functions_entry& x_r ATTRIBUTE_UNUSED)
{
  ...
  gt_ggc_m_31vec_cp_default_arg_entry_va_gc_ ((*x).noexcepts);
  gt_ggc_m_15vec_tree_va_gc_ ((*x).contracts);
}

void
gt_ggc_mx_vec_omp_begin_declare_variant_map_entry_va_gc_ (void *x_p)
{
  vec<omp_begin_declare_variant_map_entry,va_gc> * const x = (vec<omp_begin_declare_variant_map_entry,va_gc> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx (struct omp_begin_declare_variant_map_entry& x_r ATTRIBUTE_UNUSED)
{
  struct omp_begin_declare_variant_map_entry * ATTRIBUTE_UNUSED x = &x_r;
  gt_ggc_m_9tree_node ((*x).variant);
  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_46vec_omp_begin_declare_variant_map_entry_va_gc_ ((*x).omp_begin_declare_variant_map);
    }
}
...
gt_pch_nx (struct cp_unparsed_functions_entry& x_r ATTRIBUTE_UNUSED)
{
  ...
  gt_pch_n_31vec_cp_default_arg_entry_va_gc_ ((*x).noexcepts);
  gt_pch_n_15vec_tree_va_gc_ ((*x).contracts);
}

void
gt_pch_nx_vec_omp_begin_declare_variant_map_entry_va_gc_ (void *x_p)
{
  vec<omp_begin_declare_variant_map_entry,va_gc> * const x = (vec<omp_begin_declare_variant_map_entry,va_gc> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_46vec_omp_begin_declare_variant_map_entry_va_gc_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct omp_begin_declare_variant_map_entry& x_r ATTRIBUTE_UNUSED)
{
  struct omp_begin_declare_variant_map_entry * ATTRIBUTE_UNUSED x = &x_r;
  gt_pch_n_9tree_node ((*x).variant);
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_9cp_parser))
    {
      ...
      gt_pch_n_46vec_omp_begin_declare_variant_map_entry_va_gc_ ((*x).omp_begin_declare_variant_map);
    }
}
...
void
gt_pch_p_46vec_omp_begin_declare_variant_map_entry_va_gc_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct vec<omp_begin_declare_variant_map_entry,va_gc> * x ATTRIBUTE_UNUSED = (struct vec<omp_begin_declare_variant_map_entry,va_gc> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct omp_begin_declare_variant_map_entry* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).omp_begin_declare_variant_map), NULL, cookie);
}
