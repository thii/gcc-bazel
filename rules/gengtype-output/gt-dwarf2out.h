...
void
gt_ggc_mx_annotation_node (void *x_p)
{
  struct annotation_node * const x = (struct annotation_node *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_m_S ((*x).name);
      gt_ggc_m_S ((*x).value);
      gt_ggc_m_10die_struct ((*x).die);
      gt_ggc_m_15annotation_node ((*x).next);
    }
}

void
gt_ggc_mx (struct annotation_node& x_r ATTRIBUTE_UNUSED)
{
  struct annotation_node * ATTRIBUTE_UNUSED x = &x_r;
  gt_ggc_m_S ((*x).name);
  gt_ggc_m_S ((*x).value);
  gt_ggc_m_10die_struct ((*x).die);
  gt_ggc_m_15annotation_node ((*x).next);
...
void
gt_ggc_mx (struct annotation_node *& x)
{
  if (x)
    gt_ggc_mx_annotation_node ((void *) x);
}

void
gt_ggc_mx_hash_table_annotation_node_hasher_ (void *x_p)
{
  hash_table<annotation_node_hasher> * const x = (hash_table<annotation_node_hasher> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx (struct annotation_node_hasher& x_r ATTRIBUTE_UNUSED)
{
  struct annotation_node_hasher * ATTRIBUTE_UNUSED x = &x_r;
}
...
void
gt_pch_nx_annotation_node (void *x_p)
{
  struct annotation_node * const x = (struct annotation_node *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_15annotation_node))
    {
      gt_pch_n_S ((*x).name);
      gt_pch_n_S ((*x).value);
      gt_pch_n_10die_struct ((*x).die);
      gt_pch_n_15annotation_node ((*x).next);
    }
}

void
gt_pch_nx (struct annotation_node& x_r ATTRIBUTE_UNUSED)
{
  struct annotation_node * ATTRIBUTE_UNUSED x = &x_r;
  gt_pch_n_S ((*x).name);
  gt_pch_n_S ((*x).value);
...
void
gt_pch_nx (struct annotation_node *& x)
{
  if (x)
    gt_pch_nx_annotation_node ((void *) x);
}

void
gt_pch_nx_hash_table_annotation_node_hasher_ (void *x_p)
{
  hash_table<annotation_node_hasher> * const x = (hash_table<annotation_node_hasher> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_34hash_table_annotation_node_hasher_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct annotation_node_hasher& x_r ATTRIBUTE_UNUSED)
{
  struct annotation_node_hasher * ATTRIBUTE_UNUSED x = &x_r;
}
...
void
gt_pch_p_15annotation_node (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct annotation_node * x ATTRIBUTE_UNUSED = (struct annotation_node *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).name), NULL, cookie);
  if ((void *)(x) == this_obj)
...
void
gt_pch_nx (struct annotation_node* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
    op (&((*x).name), NULL, cookie);
...
void
gt_pch_p_34hash_table_annotation_node_hasher_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct hash_table<annotation_node_hasher> * x ATTRIBUTE_UNUSED = (struct hash_table<annotation_node_hasher> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct annotation_node_hasher* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
}
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_dwarf2out_h[] = {
  ...
  },
  {
    ...
    1,
    sizeof (btf_tag_htab),
    &gt_ggc_mx_hash_table_annotation_node_hasher_,
    &gt_pch_nx_hash_table_annotation_node_hasher_
  },
  {
