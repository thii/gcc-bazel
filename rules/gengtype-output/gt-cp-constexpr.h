  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_9tree_node ((*x).bindings);
      {
        ...
        size_t l0 = (size_t)(3);
        for (i0 = 0; i0 != l0; i0++) {
          gt_ggc_m_9tree_node ((*x).results[i0]);
        }
      }
    }
}
...
gt_ggc_mx (struct constexpr_call& x_r ATTRIBUTE_UNUSED)
{
  ...
  gt_ggc_m_9tree_node ((*x).bindings);
  {
    ...
    size_t l1 = (size_t)(3);
    for (i1 = 0; i1 != l1; i1++) {
      gt_ggc_m_9tree_node ((*x).results[i1]);
    }
  }
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_14constexpr_call))
    {
      ...
      gt_pch_n_9tree_node ((*x).bindings);
      {
        ...
        size_t l0 = (size_t)(3);
        for (i0 = 0; i0 != l0; i0++) {
          gt_pch_n_9tree_node ((*x).results[i0]);
        }
      }
    }
}
...
gt_pch_nx (struct constexpr_call& x_r ATTRIBUTE_UNUSED)
{
  ...
  gt_pch_n_9tree_node ((*x).bindings);
  {
    ...
    size_t l1 = (size_t)(3);
    for (i1 = 0; i1 != l1; i1++) {
      gt_pch_n_9tree_node ((*x).results[i1]);
    }
  }
}
