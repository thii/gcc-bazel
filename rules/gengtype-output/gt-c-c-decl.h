...
void
gt_ggc_mx_vec_c_omp_declare_variant_attr_va_gc_ (void *x_p)
{
  vec<c_omp_declare_variant_attr,va_gc> * const x = (vec<c_omp_declare_variant_attr,va_gc> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx (struct c_omp_declare_variant_attr& x_r ATTRIBUTE_UNUSED)
{
  struct c_omp_declare_variant_attr * ATTRIBUTE_UNUSED x = &x_r;
...
void
gt_pch_nx_vec_c_omp_declare_variant_attr_va_gc_ (void *x_p)
{
  vec<c_omp_declare_variant_attr,va_gc> * const x = (vec<c_omp_declare_variant_attr,va_gc> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_37vec_c_omp_declare_variant_attr_va_gc_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct c_omp_declare_variant_attr& x_r ATTRIBUTE_UNUSED)
{
  struct c_omp_declare_variant_attr * ATTRIBUTE_UNUSED x = &x_r;
...
void
gt_pch_p_37vec_c_omp_declare_variant_attr_va_gc_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct vec<c_omp_declare_variant_attr,va_gc> * x ATTRIBUTE_UNUSED = (struct vec<c_omp_declare_variant_attr,va_gc> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct c_omp_declare_variant_attr* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_c_c_decl_h[] = {
  {
    ...
    1,
    sizeof (current_omp_declare_variant_attribute),
    &gt_ggc_mx_vec_c_omp_declare_variant_attr_va_gc_,
    &gt_pch_nx_vec_c_omp_declare_variant_attr_va_gc_
  },
  {
