...
void
gt_ggc_mx_hash_map_tree_long_identifier_count_traits_ (void *x_p)
{
  hash_map<tree,long,identifier_count_traits> * const x = (hash_map<tree,long,identifier_count_traits> *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (x);
    }
...
void
gt_ggc_mx (struct identifier_count_traits& x_r ATTRIBUTE_UNUSED)
{
  struct identifier_count_traits * ATTRIBUTE_UNUSED x = &x_r;
}
...
void
gt_pch_nx_hash_map_tree_long_identifier_count_traits_ (void *x_p)
{
  hash_map<tree,long,identifier_count_traits> * const x = (hash_map<tree,long,identifier_count_traits> *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_43hash_map_tree_long_identifier_count_traits_))
    {
      gt_pch_nx (x);
    }
}
...
void
gt_pch_nx (struct identifier_count_traits& x_r ATTRIBUTE_UNUSED)
{
  struct identifier_count_traits * ATTRIBUTE_UNUSED x = &x_r;
}
...
void
gt_pch_p_43hash_map_tree_long_identifier_count_traits_ (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct hash_map<tree,long,identifier_count_traits> * x ATTRIBUTE_UNUSED = (struct hash_map<tree,long,identifier_count_traits> *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x)), op, cookie);
}

void
gt_pch_nx (struct identifier_count_traits* x ATTRIBUTE_UNUSED,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
}
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_tree_h[] = {
  ...
  },
  {
    &internal_label_nums,
    1,
    sizeof (internal_label_nums),
    &gt_ggc_mx_hash_map_tree_long_identifier_count_traits_,
    &gt_pch_nx_hash_map_tree_long_identifier_count_traits_
  },
  {
    &debug_args_for_decl,
    1,
